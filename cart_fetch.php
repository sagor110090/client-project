...
if (isset($_SESSION['user'])) {
    try {
        ...
        foreach ($stmt as $row) {
            ...
            $output['list'] .= "<li class='single-shopping-cart'>
				<div class='shopping-cart-img'>
					<a href='product.php?product=" . $product['slug'] . "'><img alt=''
							src='" . $image . "' /></a>
					<span class='product-quantity'>" . $row['quantity'] . "</span>
				</div>
				<div class='shopping-cart-title'>
					<h4><a href='product.php?product=" . $product['slug'] . "'" . $product['prodname'] . "</a></h4>
					<span>$9.00</span>
